...
//線を描画する
void Mesh3D::DrawLine(EngineMathF::Vector3 start, EngineMathF::Vector3 end, EngineMathF::Vector4 color)
{
...
////三角形を描画する
//void Mesh3D::DrawTriangle(float x1, float y1, float x2, float y2, float x3, float y3, EngineMathF::Vector4 color, int fillFlag)
//{
//	if (fillFlag)
//	{
...
//
////四角形を描画する
//void Mesh3D::DrawBox(float x, float y, float radiusX, float radiusY, float angle, EngineMathF::Vector4 color, int fillFlag)
//{
//	if (fillFlag)
//	{
...
//
////楕円を描画する
//void Mesh3D::DrawEllipse(float x, float y, float radiusX, float radiusY, float angle, EngineMathF::Vector4 color, int fillMode)
//{
//	constexpr UINT NumDiv = 64; // 分割数
//	float RadianPerDivision = EngineMathF::AX_2PIF / float(NumDiv); // 分割1単位の角度
//
...
//色コードを取得する
EngineMathF::Vector4 Mesh3D::GetColor(int red, int blue, int green, int alpha)
{
...
EngineMathF::Vector4 Mesh3D::GetColor(EngineMathF::Vector4 color)
{
...
//三角形を描画する(中身塗りつぶし)
void Mesh3D::DrawTriangleFill(float x1, float y1, float x2, float y2, float x3, float y3, EngineMathF::Vector4 color)
{
...
//四角形を描画する(中身塗りつぶし)
void Mesh3D::DrawBoxFill(float x, float y, float radiusX, float radiusY, float angle, EngineMathF::Vector4 color)
{
