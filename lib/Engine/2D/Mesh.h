...
public:
	...
	void DrawTriangle(float x1, float y1, float x2, float y2, float x3, float y3, EngineMathF::Vector4 color, int fillFlag);
	...
	void DrawLine(float x1, float y1, float x2, float y2, EngineMathF::Vector4 color);
	...
	void DrawBox(float x, float y, float radiusX, float radiusY, float angle, EngineMathF::Vector4 color, int fillFlag);
	...
	///<param name="fillFlag">: 四角形の中身を塗りつぶすかフラグ</param>
	void DrawEllipse(float x, float y, float radiusX, float radiusY, float angle, EngineMathF::Vector4 color, int fillMode);
